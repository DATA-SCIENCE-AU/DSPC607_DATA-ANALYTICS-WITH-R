# Ex7. Write a R program to predict whether A Person is male or female Based on Height 
# Using Bayes Theorem (Assume p(maIe)=0.5 and p(femaIe)=0.5 and Evidence = 1)
# Bayes Rule P(male lh) and P(female Ih) Training function Using Normal Density 
